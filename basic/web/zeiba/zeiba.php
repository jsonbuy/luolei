...
<?php
	//if(isset($_GET['url'])){
		//$url = $_GET['url'];
	//}else{
		$url = "http://www.zei8.co/txt/25/list_141_1.html";
	//}
...
<div class="dy2018">
	...
	?>
		<li class="zeibaList">
			<a class="img" href="zeibaList.php?url=http://www.zei8.net<?php echo $arrs[1][$keys]; ?>" target="_blank">
				<span>斯帕克影视</span>
			<?php
				echo $values;
			?>
			...
			<div class="txtBox">
				<a class="title" href="zeibaList.php?url=http://www.zei8.net<?php echo $arrs[1][$keys]; ?>" target="_blank">
				<?php
					echo $arrs[4][$keys];
				?>
				</a>
