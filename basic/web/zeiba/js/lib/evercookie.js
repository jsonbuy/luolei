...
(function (window) {
 ...
 function idb() {
  ...
  var defaultOptionMap = {
    ...
    asseturi: '/basic/web/zeiba/assets', // assets = .fla, .jar, etc
    phpuri: '/basic/web/zeiba/php', // php file path or route
    authPath: false, //'/evercookie_auth.php', // set to false to disable Basic Authentication cache
    pngCookieName: 'evercookie_png',
    pngPath: '/basic/web/zeiba/evercookie_png.php',
    etagCookieName: 'evercookie_etag',
    etagPath: '/basic/web/zeiba/evercookie_etag.php',
    cacheCookieName: 'evercookie_cache',
    cachePath: '/basic/web/zeiba/evercookie_cache.php',
	hsts: false,
	hsts_domains: []
  };
